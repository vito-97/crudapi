...
namespace app\waterworks\listener\dashboard;
...
class DashboardListener
{
    ...
    public function handle($params)
    {
        ...
        $params->merge([
            ...
            'count_order'         => $orderLogic->where($orderWhere)->count(),

            'total_used_flow'              => (int)$deviceLogic->sumTotal('used_flow', $where),
            'total_today_used_flow'        => (int)$flowLogic->sumTotal('flow', $where, 1, 'day'),
            'total_month_used_flow'        => (int)$flowLogic->sumTotal('flow', $where, 1, 'month'),
            'total_year_used_flow'         => (int)$flowLogic->sumTotal('flow', $where, 1, 'year'),
