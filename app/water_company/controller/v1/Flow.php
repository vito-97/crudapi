...
class Flow extends BaseController
{
    ...
    public function used($page = 1, $limit = 15, $type = 'waterworks')
    {
    ...
    public function surplus($page = 1, $limit = 15, $type = 'customer')
    {
        SurplusFlowStatisticsValidate::batchCheck('flow');
        PaginateValidate::batchCheck();

        $method = 'surplus' . Str::studly($type);
    ...
    protected function usedWaterworks($page, $limit)
    {
        $logic = new WaterworksLogic();
    ...
    protected function usedCustomer($page, $limit)
    {
    ...
    protected function surplusCustomer($page, $limit)
    {
        $logic = new CustomerLogic();
        ...
        $args = [
            ...
            'where'    => [
                ['user_id', '=', $this->uid()],
                ['flow', '<=', $this->request->param('min', 10000, 'intval')],
            ],
            'order'    => [
                'flow' => 'asc',
            ],
